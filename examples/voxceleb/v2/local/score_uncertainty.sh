...
#
# Same as local/score.sh, but uses the uncertainty-aware cosine score and
# writes the results to ${exp_dir}/scores_uncertainty.
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
  echo "apply uncertainty-aware cosine scoring ..."
